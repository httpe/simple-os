    ...
    *vaddr_ub = 0;
    for (Elf32_Half i = 0; i < n_program_header; i++) {
        ...
        if (program_header.p_type == PT_LOAD) {
            ...
            // alloc_pages_at(page_dir, program_header.p_vaddr, program_header.p_memsz, is_kernel, (program_header.p_flags & PF_W)==PF_W);
            char* dest_ptr = (char*) link_pages(page_dir, program_header.p_vaddr, program_header.p_memsz, curr_page_dir(), (program_header.p_flags & PF_W)==PF_W);
