...
global ADDR_MMAP_ADDR, ADDR_MMAP_COUNT
ADDR_MMAP_COUNT dd 0x0500
ADDR_MMAP_ADDR dd 0x0504

do_e820:
    mov di, [ADDR_MMAP_ADDR]          ; Set di to 0x0504. Otherwise this code will get stuck in `int 0x15` after some entries are fetched 
	xor ebx, ebx		; ebx must be 0 to start
	xor bp, bp		; keep an entry count in bp
	mov edx, 0x0534D4150	; Place "SMAP" into edx
	mov eax, 0xe820

    mov dword [es:di], 24; populate `size` field of standard multi-boot memory layout entry
    add di, 4
